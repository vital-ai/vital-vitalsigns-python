...
def insert_triples_to_fuseki(triples, graph_uri, fuseki_url, dataset, batch_size=20000):
    ...
    try:
        ...
        for block in par_reader:
            ...
            for triple in triples:
                ...
                batch_list.append(triple)

                if len(batch_list) >= 40_000:
                    insert_triples_to_fuseki(batch_list, wordnet_graph_uri, fuseki_url, dataset)
                    batch_list = []
        ...
        print(f"Worker{par_reader.num} Completed Insert. Delta: {block_delta_time}")
...
def main():
    ...
    parallel_list = read_file.get_parallel_readers(25)
