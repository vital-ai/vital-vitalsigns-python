...
def test_virtuoso_odbc_connectivity():
    """
    Test that we can connect to the Virtuoso ODBC instance and execute a simple SPARQL query.
    """
    connection_string = (
    ...
    try:
        ...
        # Just fetch one result to verify connectivity
