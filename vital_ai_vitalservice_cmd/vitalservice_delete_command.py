...
class VitalServiceDeleteCommand:
    ...
    def create_parser(self):
        ...
        parser = argparse.ArgumentParser(prog="vitalservice_delete", description="VitalServiceDelete Command", add_help=True)
    ...
    def info(self):
        ...
        print("VitalServiceDelete Info")
        print(f"Current VITAL_HOME: {vital_home}")


def main():
    import sys
    command = VitalServiceDeleteCommand(sys.argv[1:])
    command.run()
